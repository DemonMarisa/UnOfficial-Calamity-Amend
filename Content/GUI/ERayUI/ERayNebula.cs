...
{
    public class ERayNebula : RouletteUIPart
    {
        ...
        public override void MouseLeft()
        {
            ...
            player.UCA().ElementalRayStates = ElementalRayState.Nebula;
            LAPContent.DeActive(Parent);
        }
        public override void Draw(SpriteBatch spriteBatch)
        {
            Texture2D Misc = UCATextureRegister.ElementalRayNebula.Value;
