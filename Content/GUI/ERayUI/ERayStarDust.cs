...
{
    public class ERayStarDust : RouletteUIPart
    {
        ...
        public override void MouseLeft()
        {
            ...
            player.UCA().ElementalRayStates = ElementalRayState.StarDust;
            LAPContent.DeActive(Parent);
        }
        public override void Draw(SpriteBatch spriteBatch)
        {
            Texture2D Misc = UCATextureRegister.ElementalRayStarDust.Value;
