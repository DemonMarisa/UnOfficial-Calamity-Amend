...
{
    public class ERayVortex : RouletteUIPart
    {
        ...
        public override void MouseLeft()
        {
            ...
            player.UCA().ElementalRayStates = ElementalRayState.Vortex;
            LAPContent.DeActive(Parent);
        }
        public override void Draw(SpriteBatch spriteBatch)
        {
            Texture2D Misc = UCATextureRegister.ElementalRayVortex.Value;
