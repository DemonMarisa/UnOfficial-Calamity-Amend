...
{
    public class VividClarityUI_Defense : RouletteUIPart
    {
        ...
        public override void MouseLeft()
        {
            ...
            player.UCA().VividClarityStates = VividClarityState.Defense;
            LAPContent.DeActive(Parent);
        }
        public override void Draw(SpriteBatch spriteBatch)
        {
            Texture2D Misc = UCATextureRegister.VividClarityDefense.Value;
