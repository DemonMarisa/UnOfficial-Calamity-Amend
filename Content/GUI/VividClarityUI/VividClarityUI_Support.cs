...
{
    public class VividClarityUI_Support : RouletteUIPart
    {
        ...
        public override void MouseLeft()
        {
            ...
            player.UCA().VividClarityStates = VividClarityState.Support;
            LAPContent.DeActive(Parent);
        }
        public override void Draw(SpriteBatch spriteBatch)
        {
            Texture2D Misc = UCATextureRegister.VividClaritySupport.Value;
