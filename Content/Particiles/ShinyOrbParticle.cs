...
namespace UCA.Content.Particiles
{
    public class ShinyOrbParticle : BaseParticle
    {
        ...
        public ShinyOrbParticle(Vector2 position, Vector2 velocity, Color color, int lifeTime, float scale, int? blendState = null, bool affactedByGravity = false, bool glowCenter = true )
        {
            Position = position;
            Velocity = velocity;
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            ...
            Texture2D texture = UCATextureRegister.Particle_ShinyOrb.Value;
