...
{
    public class StormShockWaveTest : BaseMeleeProj, IPixelatedRenderer
    {
        public override string Texture => LAPTextureRegister.InvisibleTexturePath;
        public ref float Heigh => ref Projectile.ai[0];
        public ref float Second => ref Projectile.ai[1];
        public List<Vector2> CenterPos = [];
        Vector2 TopLeft = new Vector2(-300, -20);
        Vector2 MiddleRightUp = new Vector2(0, -100);
        ...
        public override void AI()
        {
            ...
            if (Projectile.LAP().FirstFrame)
            {
                ...
                if (Second == 0f)
                {
                    MiddleRightUp = new Vector2(0, -100);
                    MiddleRightDown = new Vector2(25, 100);
                }
                else
                {
                    MiddleRightUp = new Vector2(25, -100);
                    MiddleRightDown = new Vector2(0, 100);
                }
        ...
        {
            Main.spriteBatch.Draw(LAPTextureRegister.WhiteCube.Value, Projectile.Center - Main.screenPosition, null, Color.Black, 0, LAPTextureRegister.WhiteCube.Size() / 2, 100, SpriteEffects.None, default);
        ...
        public void RenderPixelated(SpriteBatch spriteBatch)
        {
            ...
            DrawBaseWave(texture, Color.Violet * 0.8f, 1f);
            DrawBaseWave(texture, Color.Violet * 0.5f, 3f);
            DrawBaseWave(texture, Color.Violet * 0.5f, 10f);
            DrawBaseWave(texture, Color.DeepPink * 0.2f, 15f);
            if (!LAPConfig.Instance.PerformanceMode)
            {
                ...
                DrawBaseWave(texture2, Color.DarkViolet, 10f);
                ...
                DrawBaseWave(texture2, Color.DeepPink, 20f);
                ...
                DrawBaseWave(texture2, Color.Violet, 10f);
                ...
                DrawBaseWave(texture2, Color.Pink, 15f);
            }
