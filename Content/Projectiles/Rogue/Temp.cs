...
namespace UCA.Content.Projectiles.Rogue
{
    public static class Temp
    {
        ...
        public static void QuickAddTooltip(this List<TooltipLine> tooltips, string textPath, Color? color = null, Mod mod = null, string LineName = "UCAMod")
        {
        ...
        public static void QuickAddTooltip(this List<TooltipLine> tooltips, string textPath, Color? color = null, Mod mod = null, string LineName = "UCAMod", params object[] args)
        {
        ...
        public static void QuickAddTooltipDirect(this List<TooltipLine> tooltips, string textValue, Color? color = null, Mod mod = null, string LineName = "UCAMod")
        {
        ...
        /// <param name="mod">该段文本所属的模组，默认值null，将直接选定为本mod</param>
        /// <param name="LineName">为这一行tooltip起名，默认CEMod</param>
        public static void QuickAddTooltipDirect(this List<TooltipLine> tooltips, string textValue, Color? color = null, Mod mod = null, string LineName = "UCAMod", params object[] args)
        {
