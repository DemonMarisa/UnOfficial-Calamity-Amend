...
{
    public class ShadowBotlStaffDodge : CooldownHandler
    {
        public static new string ID => "UCAShadowBotlStaffDodgeCooldown";
        public override bool ShouldDisplay => true;
        public override LocalizedText DisplayName => Language.GetOrRegister($"Mods.UCA.Cooldowns.{ID}");
        public override string Texture => "UCA/Content/UCACooldowns/ShadowBotlStaffDodge";
        public override string OutlineTexture => "UCA/Content/UCACooldowns/ShadowBotlStaffDodge_OutLine";
        public override string OverlayTexture => "UCA/Content/UCACooldowns/ShadowBotlStaffDodge_Overlay";
