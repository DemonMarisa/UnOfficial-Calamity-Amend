...
namespace UCA.Core.SpecificEffectManagers
{
    public class ScreenShakeInfo(Vector2 ShakePosition, float ShakeStrength, int ShakeTime, float ShakeDirection, float ShakeAngleOffset, bool useDiatanceFade, int ShakeEffectDistance)
    {
        ...
        public void Update()
        {
            ...
            Main.screenPosition += Vector2.UnitX.RotatedBy(ShakeDirection).RotatedByRandom(ShakeAngleOffset) * Shake * UCAConfig.Instance.ScreenShakeStrength;
            ShakeTime++;
        }
    }
